...
export default function Hero3D() {
  ...
  useEffect(() => {
    ...
    // desabilita zoom/pan para que o scroll da página funcione
    ...
    loader.load(
      ...
      (gltf) => {
        ...
        // desloca ligeiramente para baixo para ficar mais centralizado na tela
  ...
  return (
    <section className="relative h-[100vh] w-full overflow-hidden pointer-events-none">
