...
export default function Hero3D() {
  ...
  useEffect(() => {
    ...
    camera.position.set(0, 1.4, 3); // levanta ligeiramente para enquadrar o modelo mais abaixo
    ...
    // bloqueia interações de câmera para o scroll da página fluir
    ...
    function onScroll() {
      ...
      const scrollTop =
        ...
        0;
      const progress =
        Math.max(0, Math.min(1, scrollTop / maxScroll)) * 100;
    ...
    loader.load(
      "/models/phone.glb",
      (gltf) => {
        // remove trilhas de posição/escala para manter o modelo fixo
        ...
        // baixa o modelo na cena para aparecer mais ao centro da página
        ...
        controls.dispose(); // remove listeners para não bloquear o scroll
