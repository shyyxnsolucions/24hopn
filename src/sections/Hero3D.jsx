...
export default function Hero3D() {
  ...
  useEffect(() => {
    ...
    // Controles (desabilita toda interação para não capturar scroll)
    const controls = new OrbitControls(camera, renderer.domElement);
    controls.enableRotate = false;
    controls.autoRotate = false;
    controls.enableZoom = false; // evita aproximação/afastamento com scroll
    controls.enablePan = false; // garante modelo fixo
    renderer.domElement.style.pointerEvents = "none"; // libera scroll da página
